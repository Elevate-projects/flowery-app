...
@injectable
class OccasionsViewModel extends Cubit<StateStatus<List<OccasionArgumentsEntity>>> {
  OccasionsViewModel( this._homeProductsUseCase):super(const StateStatus.initial());
